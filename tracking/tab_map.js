...
function addTandaKapal(data, index) {
    ...
    var date_val = new Date(data.epoch * 1000);
...
function create_infowindow(t, d, index, mode) {
    ...
    // console.log('date_val.getTime()', date_val.getTime());
    // console.log('date_val.getTime()+(60*1000*10)', date_val.getTime() + (60 * 1000 * 10));
    // console.log('date_cur.getTime()', date_cur.getTime());
    
    // var sel_model = tabel_daftar_kapal.getSelectionModel();
    // console.log('sel_model', sel_model);
    // var record = sel_model.getSelection()[index];
    // console.log('record', record);
    // record.set("number","");
    // // tabel_daftar_kapal.reconfigure(store_daftar_kapal);
    // // tabel_daftar_kapal.getView().refresh(); 
    // tabel_daftar_kapal.bindStore(store_daftar_kapal);
    ...
    columns: [{
        ...
        },
        {
            ...
            renderer: function (value) {
                ...
                // info_ves[index] += '<p>Health Status : <b><font color="green" size="3">OK</font></b></p>';
                // console.log('info_ves[value]', info_ves[value]);
                return value;
            }
        }, 
        {
            ...
            renderer: function (value) {
                ...
                return '<span align="center" style="background-color:' + value['color'] + ';height:15px;width:15px;border:1px solid black;display:block;">&nbsp</span>';
            }
        }
    ],
    listeners: {
